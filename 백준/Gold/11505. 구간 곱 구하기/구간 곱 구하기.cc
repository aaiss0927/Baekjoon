...
void init(int node, int s, int e) {
	if (s == e)
		...
		t[node] = ((t[node * 2] % 1000000007) * (t[node * 2 + 1] % 1000000007)) % 1000000007;
	}
}
...
long long query(int node, int s, int e, int l, int r) {
	...
	long long lsum = query(node * 2, s, (s + e) / 2, l, r) % 1000000007;
	long long rsum = query(node * 2 + 1, (s + e) / 2 + 1, e, l, r) % 1000000007;
